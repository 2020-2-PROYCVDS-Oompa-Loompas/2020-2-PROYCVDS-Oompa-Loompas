...
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Torre', 'HP', false, true, 'Computador 1');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Pantalla', 'HP', false, true, 'Computador 1');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Mouse', 'HP', false, true, 'Computador 1');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Teclado', 'HP', false, true, 'Computador 1');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Torre', 'Microsoft', false, true, 'Computador 2');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Pantalla', 'Microsoft', false, true, 'Computador 2');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Mouse', 'Microsoft', false, true, 'Computador 2');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Teclado', 'Microsoft', false, true, 'Computador 2');
insert into Elemento(categoria, fabricante, disponible, funcionamiento, equipo) values ('Teclado', 'Genius', true, true, null);
